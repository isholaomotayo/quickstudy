...
module.exports = {
  admit: (name, LoginCode = "", program = "Pre-MBA") => `<!DOCTYPE html>
<html lang="en">
    <head>
                                                ...
                                                <tr>
                                                    ...
                                                    Dear ${
                                                      name || "Applicant"
                                                        ...
                                                        Learning programme with effect from the 2019/2020 Academic Session.</p> 
                                                        <p>You have been awarded admission into the <b>${program} Program</b>. This is to
                                                        plug the envisaged knowledge gap as MBA students are required to have a
                                                        background knowledge in the Business discipline.</p>
                                                        <p>The ${program} is an additional semester that introduces students to the basic
                                                        principles of business concepts.</p>
                                                        <p> <!--[if !supportLists]-->2. <!--[endif]-->To indicate your acceptance of the offer, you
