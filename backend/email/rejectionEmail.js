module.exports = {
  rejectionMail: (name = "", reason = "") => `<!DOCTYPE html>
      <html lang="en">
          <head>
              <title>Application Response for ${name}</title>
              <meta charset="utf-8">
                                              ...
                                              <td>
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <tr>
                                                          ...
                                                          Dear ${name},</p></b><b>Application Response for ${name}
                                                                  </b></p> <p> <!--[if !supportLists]--> <!--[endif]--> We regret that we are not able to offer you admission to the University of
                                                                  Nigeria, Nsukka (UNN) Master of Business Administration (MBA)
                                                                  Distance Learning program at this time. As you probably know, we
                                                                  carefully scrutinize every application, and admission decisions are based
                                                                  on a combination of information including your previous academic
                                                                  performance and relevant professional certifications.
                                                                  There is a rigorous competition for entry into our graduate programs and
                                                                  unfortunately, your application was not among those that we were able
                                                                  to accept at this time due to the fact that ${reason.toLowerCase()}.</p>                                                        
                                                                   <p>We appreciate your interest in our program and certainly wish you the
                                                                   best.</p>
                                                                   <p>Yours Sincerely,</p>
