...
import { CgpaError } from "./components/cgpa-error";
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        // Get student results using the student-specific endpoint (for credits calculation)
        let studentResults: StudentResult[] = [];
        const resultsResponse = await fetch(`/api/studentresult/${studentId}`, {
          headers,
          credentials: "include",
        });
