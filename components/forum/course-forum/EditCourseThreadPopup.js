...
class EditCourseThreadPopup extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <>
        {Number(this.props.authUser) === Number(this.props.userId) ? (
          <span
            className=" ml-4 cursors edite"
            onClick={() => {
              this.props.handleThreadClick(this.props.id);
              this.openModal();
            }}
          >
        ...
        >
          <EditComment
            ...
            thread={this.props.singleThread}
...
export { EditCourseThreadPopup as default };
