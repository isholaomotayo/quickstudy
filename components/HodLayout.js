...
const HodLayout = (props) => {
  ...
  const fetchedPermissions = [
    { href: "/hod", label: "Home", iconClass: "pg-home" },
    { href: "/hod/view", label: "My Profile", iconClass: "fa fa-user" },
    {
      href: "/hod/announcement",
      label: "Announcements",
      iconClass: "fa fa-envelope",
    },
    { href: "/hod/my-courses", label: "My Courses", iconClass: "fa fa-book" },
    { href: "/lms", label: "LMS Dashboard", iconClass: "fa fa-briefcase" },
    {
      href: "/hod/view-department",
      label: "Department",
      iconClass: "fa fa-institution",
    },
    { href: "/hod/staff", label: "Staff", iconClass: "fa fa-address-book" },
    { href: "/hod/students", label: "Students", iconClass: "fa fa-users" },
    { href: "/hod/programmes", label: "Programmes", iconClass: "fa fa-list" },
    { href: "/hod/courses", label: "Courses", iconClass: "fa fa-th-list" },
    {
      href: "/hod/results",
      label: "Results",
    ...
    {
      href: "/hod/school-calendar",
      label: "School Calendar",
      iconClass: "fa fa-calendar",
    },
    { href: "/hod/faq", label: "Help & Support", iconClass: "fa fa-question" },
