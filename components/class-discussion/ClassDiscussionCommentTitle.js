import NewDiscussionComment from "./NewDiscussionComment";
import { checkTopicDate } from "../../helpers/discussion-helpers/discussion-utils";

const ClassDiscussionCommentTitle = props => {
          ...
          <div className="row p-b-60 p-t-60">
              ...
              {props.topic.map(x => {
                return (
                  <div key={x.id}>
                    ...
                    <p className="opacity-75">{x.body}</p>
                  </div>
                );
              })}
              <div className="row">
            ...
            <div className="col-md-4 m-auto text-white p-b-30">
              <div className="text-md-right">
                {props.topic.length > 0 && checkDate === true && (
...
export default ClassDiscussionCommentTitle;
