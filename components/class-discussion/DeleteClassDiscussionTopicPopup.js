...
const DeleteCourseDiscussionTopicPopups = props => (
  <div className="modals">
    ...
    <div className="actions mx-4 px-2 float-right">
      <button
        className="btn  text-white btn-info btn-cons m-t-10"
        onClick={() => {
          props.close();
        }}
      >
...
class DeleteCourseDiscussionTopicPopup extends React.Component {
  constructor(props) {
    super(props);
...
export { DeleteCourseDiscussionTopicPopup as default };
