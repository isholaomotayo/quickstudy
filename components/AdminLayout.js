...
const AdminLayout = (props) => {
  ...
  const fetchedPermissions = [
    { href: "/admin", label: "Home", iconClass: "pg-home" },
    { href: "/admin/view", label: "My Profile", iconClass: "fa fa-user" },
    {
    ...
    {
      href: "/admin/view-institution",
      label: "My Institution",
      iconClass: "fa fa-institution",
    },
    { href: "/admin/fees", label: "Fees", iconClass: "fa fa-dollar" },
    { href: "/admin/staff", label: "Staff", iconClass: "fa fa-address-book" },
    { href: "/admin/students", label: "Students", iconClass: "fa fa-users" },
    {
    ...
    { href: "/admin/programmes", label: "Programmes", iconClass: "fa fa-list" },
    { href: "/admin/courses", label: "Courses", iconClass: "fa fa-th-list" },
    {
      href: "/calendar",
