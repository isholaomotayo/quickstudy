...
const StudentGpa = () => (
  <HodLayout pageTitle="Course Results">
    ...
    <table className="table table-condensed table-hover">
      ...
      <tbody>
        <tr>
        <td> <span className="font-montserrat fs-18">
              CSC/18/0001
            </span></td>
          <td className="w-25">
          ...
          <td className="w-15">
            <span className="font-montserrat fs-18"><i className="fa fa-search-plus" /> View</span>
          </td>
        </tr>
        <tr>
        <td> <span className="font-montserrat fs-18">
          ...
          <td className="w-15">
            <span className="font-montserrat fs-18 fa-fa-search-plus"> <i className="fa fa-search-plus" />View</span>
          </td>
        </tr>
